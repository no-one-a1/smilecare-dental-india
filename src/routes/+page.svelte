...
<main class="page-shell">
    ...
    <!-- Verified Dental Office Context Banner -->
    ...
    <div class="split-workspace">
        ...
        <div class="right-ledger-column">
            <div class="ledger-header">
                <h3>Active Consultation Token Stream</h3>
                <span class="count-tag">{dentalDB.appointments.length} Total Slots Reserved</span>
            </div>
                    ...
                    {#each dentalDB.appointments as record (record.id)}
                        <div class="record-row">
                            ...
                            {#if activePromptId === record.id}
                                <!-- Phone Validation Challenge Prompt -->
    ...
    <!-- Clinic Infrastructure Image Modules Section -->
...
<style>
    :global(body) { margin: 0; padding: 0; font-family: 'Segoe UI', system-ui, -apple-system, sans-serif; background-color: #f8fafc; color: #1e293b; }
    .page-shell { width: 100vw; overflow-x: hidden; }
    .top-ribbon { background: #005b52; color: #f0fdfa; display: flex; justify-content: space-between; padding: 12px 10%; font-size: 0.85rem; font-weight: 500; border-bottom: 3px solid #eab308; }
    .banner { position: relative; background-image: var(--bg-asset); background-size: cover; background-position: center; height: 50vh; display: flex; align-items: center; padding: 0 10%; }
    .scrim { position: absolute; top:0; left:0; width:100%; height:100%; background: linear-gradient(90deg, rgba(255,255,255,0.98) 40%, rgba(255,255,255,0.4) 100%); }
    ...
    .banner-inner h1 { font-size: 2.75rem; font-weight: 800; color: #0f172a; margin: 15px 0 10px 0; line-height: 1.2; }
    .banner-inner p { color: #475569; font-size: 1.05rem; }

    .split-workspace { display: grid; grid-template-columns: 1fr 1fr; gap: 40px; padding: 50px 10%; }
    @media (max-width: 960px) { .split-workspace { grid-template-columns: 1fr; padding: 20px 5%; } }

    .right-ledger-column { background: #ffffff; border: 1px solid #e2e8f0; border-radius: 12px; padding: 30px; }
    ...
    .ledger-header h3 { font-size: 1.15rem; font-weight: 700; color: #005b52; margin: 0; }
    .count-tag { background: #ccfbf1; color: #005b52; padding: 4px 12px; border-radius: 99px; font-size: 0.8rem; font-weight: 700; }
    
    .empty-placeholder { display: flex; align-items: center; justify-content: center; height: 300px; border: 2px dashed #cbd5e1; border-radius: 8px; text-align: center; color: #64748b; font-size: 0.95rem; }
    ...
    /* Verification Form Styling blocks */
    ...
    .secure-cancellation-form input { padding: 8px 12px; border: 1px solid #f43f5e; border-radius: 6px; background: #fff; font-size: 0.9rem; }
    ...
    .bottom-infrastructure-panel { padding: 50px 10%; border-top: 1px solid #e2e8f0; background: #ffffff; }
    .clinic-footer { background: #0f172a; color: #94a3b8; text-align: center; padding: 40px 20px; font-size: 0.9rem; border-top: 4px solid #005b52; }
