...
<main class="page-shell">
    ...
    <div class="center-content-stack">
        ...
        <div class="content-block table-card">
        ...
        <div class="content-block showcase-card">
            <TechShowcase />
        </div>
...
<style>
    /* Absolute reset to prevent left/right margin or tracking imbalance shifts */
    :global(html, body) { 
        margin: 0; 
        padding: 0; 
    ...
    .banner-inner h1 { font-size: 2.2rem; font-weight: 800; color: #0f172a; margin: 15px 0 10px 0; line-height: 1.2; }
    .banner-inner p { color: #475569; font-size: 1rem; }

    /* ==========================================================
       🛡️ THE UNIFIED STRAIGHT-DOWN VERTICAL CONTENT ENGINE
       ========================================================== */
    .center-content-stack {
        width: 100%;
        max-width: 650px; /* Locks components into a beautiful smartphone-friendly column width even on desktops */
        display: flex;
        flex-direction: column;
        gap: 24px;
        padding: 24px 16px; /* Completely equalized minor safety padding on edges */
        align-items: center;
    }

    .content-block {
        width: 100%; /* Forces exact matching stretch across the column uniform width rules */
    }
    ...
    /* Ledger Details */
    .ledger-header { display: flex; justify-content: space-between; align-items: center; padding-bottom: 12px; border-bottom: 2px solid #f1f5f9; margin-bottom: 16px; }
    ...
    .empty-placeholder { display: flex; align-items: center; justify-content: center; height: 200px; border: 2px dashed #cbd5e1; border-radius: 8px; text-align: center; color: #64748b; font-size: 0.9rem; padding: 15px; }
    .records-stack { display: flex; flex-direction: column; gap: 12px; max-height: 450px; overflow-y: auto; }
    ...
    .badge { display: inline-block; font-size: 0.72rem; background: #e2e8f0; color: #334155; padding: 2px 6px; border-radius: 4px; margin: 4px 0; font-weight: 600; }
    ...
    .drop-action { background: #fff1f2; border: 1px solid #ffe4e6; color: #e11d48; cursor: pointer; font-size: 0.78rem; padding: 6px 12px; border-radius: 6px; font-weight: 600; align-self: flex-start; }
    ...
    .secure-cancellation-form input { padding: 8px 12px; border: 1px solid #f43f5e; border-radius: 6px; background: #fff; font-size: 0.85rem; width: 100%; }
    ...
    /* Footer adjustments */
    .clinic-footer { width: 100%; background: #0f172a; color: #94a3b8; text-align: center; padding: 40px 16px; font-size: 0.85rem; border-top: 4px solid #005b52; margin-top: 20px; }
    .clinic-footer strong { color: #ffffff; }
    .footer-subtext { font-size: 0.78rem; margin-top: 6px; color: #64748b; }

    /* Quick adaptive optimization parameters for micro mobile phone views */
    @media (max-width: 480px) {
        .top-ribbon { flex-direction: column; gap: 6px; align-items: center; text-align: center; }
        .banner { padding: 24px 16px; }
        .banner-inner h1 { font-size: 1.5rem; }
        .banner-inner p { font-size: 0.88rem; }
        .center-content-stack { padding-top: 12px; }
    }
</style>